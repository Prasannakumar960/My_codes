...
#    text_rect=text.get_rect(centre=(300,300))
    if(find_piece_color(piece)=="blacks"):
        winner=pygame.image.load('C:\\Users\\user\\Music\\chess\\white_wins.jpg')
    else:
        winner=pygame.image.load('C:\\Users\\user\\Music\\chess\\black_wins.jpg')
    winner=pygame.transform.scale(winner,(300,150))
...
#        text = font.render('queen' , True , black) 
